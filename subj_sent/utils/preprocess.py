...
@log("Generating word embeddings")
...
@log("Generating sentence embeddings")
...
def _generate_embeddings(vocabulary_inverse : list, model : KeyedVectors, embeddings_dim : int) -> dict:
    embeddings_concatenated = np.concatenate([model.word_vec(word) for word in list(model.vocab.keys())[:10**6]])
